...
const PRESET_DESTINATIONS = [
    ...
    { label: '📄 PDF Bases Convenciones 2026', value: '/bases_campanas/Convenciones/CONVENCIONES.pdf' },
    { label: '📄 PDF Bases Camino a la Cumbre', value: '/bases_campanas/Camino a la cumbre/Bases Camino a la Cumbre_2026.pdf' },
