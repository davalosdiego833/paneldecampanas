...
rsync -avz -e "ssh $SSH_OPTS" bases_campanas/ $SERVER_USER@$SERVER_IP:$PARENT_DIR/nodejs/bases_campanas/
rsync -avz -e "ssh $SSH_OPTS" bases_campanas/ $SERVER_USER@$SERVER_IP:$PARENT_DIR/public_html/bases_campanas/ 2>/dev/null || true
